...
function setHead(crumb,title){if($("#crumb"))$("#crumb").textContent=crumb;if($("#title"))$("#title").textContent=title;}
...
function addStyles(){if($("#scheduleMeetings176Styles"))return;const s=document.createElement("style");s.id="scheduleMeetings176Styles";s.textContent=`
.sm176-page{display:grid;gap:16px}.sm176-tabs{display:flex;gap:8px;padding:6px;background:#edf4f9;border:1px solid #d9e4ee;border-radius:16px;width:max-content;max-width:100%;margin:0 0 8px}.sm176-tabs button{border:0;background:transparent;color:#24445f;padding:10px 16px;border-radius:11px;font-weight:900;cursor:pointer}.sm176-tabs button.active{background:#0b3764;color:#fff!important;-webkit-text-fill-color:#fff!important}.sm176-hero{padding:20px;border:1px solid #dbe7f2;border-radius:20px;background:linear-gradient(145deg,#fff,#f6fbff)}.sm176-hero h2{margin:0;font-size:1.45rem}.sm176-hero p{margin:6px 0 0;color:#617386}.sm176-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(290px,1fr));gap:14px}.sm176-card{border:1px solid #dbe4ee;border-radius:18px;padding:16px;background:#fff;box-shadow:0 8px 24px rgba(10,42,73,.05)}.sm176-card h3{margin:8px 0}.sm176-meta{display:grid;gap:6px;color:#5f7184;font-size:.84rem}.sm176-badge{display:inline-flex;padding:5px 9px;border-radius:999px;font-size:.72rem;font-weight:900}.sm176-badge.ok{background:#e7f7ee;color:#087443}.sm176-badge.wait{background:#fff3cf;color:#8a5d00}.sm176-badge.physical{background:#e8f1ff;color:#1659a3}.sm176-badge.online{background:#f0eaff;color:#6238a3}.sm176-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:12px}.sm176-actions button{border:0;border-radius:11px;padding:10px 13px;font-weight:900;cursor:pointer;background:#0b3764;color:#fff}.sm176-note{margin-top:10px;padding:11px 13px;border-radius:12px;background:#f5f8fb;color:#607386;font-size:.82rem}.sm176-success{margin-top:10px;padding:10px 12px;border-radius:12px;background:#e8f7ee;color:#08683e;font-weight:900}.sm176-admin-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;padding:16px;border:1px solid #dbe4ee;border-radius:18px;background:#fff}.sm176-admin-form label{display:grid;gap:6px;font-weight:800;font-size:.8rem}.sm176-admin-form label.full{grid-column:1/-1}.sm176-admin-form input,.sm176-admin-form select,.sm176-admin-form textarea{width:100%;box-sizing:border-box;border:1px solid #ccd9e6;border-radius:11px;padding:10px 11px;font:inherit;background:#fff}.sm176-admin-form button{grid-column:1/-1;justify-self:start;border:0;border-radius:11px;padding:10px 14px;background:#0b3764;color:#fff;font-weight:900}.sm176-empty{padding:18px;border:1px dashed #ccd9e6;border-radius:14px;color:#647689;background:#fafcff}@media(max-width:720px){.sm176-admin-form{grid-template-columns:1fr}.sm176-admin-form label.full{grid-column:auto}}
