function openExport(){
  const html='<!doctype html><html><head><meta charset="utf-8"><title></title><style>@page{size:A4 landscape;margin:0}html,body{margin:0!important;padding:0!important;width:100%;height:100%;background:#fff!important}body>*{display:none!important}</style></head><body><script>window.addEventListener("load",()=>setTimeout(()=>window.print(),100))<\/script></body></html>';
