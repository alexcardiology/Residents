...
async function k() {
  ...
  a.innerHTML =
    ...
    ` <div class="grid g4"> ${_("Residents", r.data?.filter((e) => "resident" === e.role).length || 0, "Active curriculum users")} ${_("Upcoming windows", c.count || 0, "Scheduled assessments")} ${_("Assessments", o.count || 0, "Permanent history")} ${_("Observer reviews", l.count || 0, "Signed comments")} </div>`;
}
function A(e) {
