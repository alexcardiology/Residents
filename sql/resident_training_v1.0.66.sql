-- Resident Training v1.0.66
-- Adds CPR as a manual logbook intervention at the end of the intervention list.
-- Updates submission validation and the Owner intervention-fairness audit ordering.
