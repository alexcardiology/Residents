...
-- Adds five new manual interventions at the end of the logbook list.
-- Safe migration: no existing logbook data is modified or deleted.
...
begin
  ...
  if p_activity_category = 'conference' then
    ...
    if p_procedure_name not in (
      ...
      'Pericardiocentesis','TEE','DSE','Coronary angiography','PCI','IVUS',
...
begin
  ...
  with procedures(name,ord) as (values
    ...
    ('TEE',9),('DSE',10),('Coronary angiography',11),('PCI',12),('IVUS',13),('Rotablation',14),
    ('TAVI',15),('ASD closure',16),('Mitral balloon valvotomy',17),
    ('Exercise stress ECG',18),('Tilting table',19),('Nuclear imaging',20),('CT CA',21),('CMR',22)
  ), residents as (
